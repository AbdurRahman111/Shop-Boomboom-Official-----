...
from . import views, views2, views3, views4, views5
...
urlpatterns = [
    ...
    path('get_notification/', views5.get_notification, name="get_notification"),
    path('get_notification_qty/', views5.get_notification_qty, name="get_notification_qty"),
    path('make_seen_notification/', views5.make_seen_notification, name="make_seen_notification"),
    path('all_notification/', views5.all_notification, name="all_notification"),
    path('get_vendor_notification/', views5.get_vendor_notification, name="get_vendor_notification"),
    path('upload_vendor_Store_details_notification/<int:pk>', views5.upload_vendor_Store_details_notification, name="upload_vendor_Store_details_notification"),
    path('vendor_get_notification_qty', views5.vendor_get_notification_qty, name="vendor_get_notification_qty"),
    path('vendor_make_seen_notification', views5.vendor_make_seen_notification, name="vendor_make_seen_notification"),
    path('vendor_all_notification', views5.vendor_all_notification, name="vendor_all_notification"),
